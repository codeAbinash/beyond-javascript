export default function highligh() {
  //* PrismJS 1.29.0 https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+c&plugins=toolbar+copy-to-clipboard */
  var _self =
